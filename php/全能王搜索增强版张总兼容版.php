...
function 获取所有文件() {
    ...
    if ($所有文件 === null) {
        ...
        $JSON文件 = 递归扫描目录('/storage/emulated/0/lz/json/影视/', ['json']);
        $TXT文件 = 递归扫描目录('/storage/emulated/0/lz/wj/', ['txt']);
        $M3U文件 = array_merge(
            递归扫描目录('/storage/emulated/0/lz/json/影视/', ['m3u']),
            递归扫描目录('/storage/emulated/0/lz/wj/', ['m3u'])
        );
        
        // 增强数据库文件扫描，包含所有可能的数据库路径
        $数据库文件 = array_merge(
            递归扫描目录('/storage/emulated/0/lz/json/影视/', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('/storage/emulated/0/lz/wj/', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('/storage/emulated/0/lz/db/', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('/storage/emulated/0/lz/wj/bt/', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('/storage/emulated/0/lz/data/', ['db', 'sqlite', 'sqlite3', 'db3']),
            递归扫描目录('/storage/emulated/0/lz/数据库/', ['db', 'sqlite', 'sqlite3', 'db3'])
        );
